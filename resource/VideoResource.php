...
/**
 * This handles video resources.
 */
class VideoResource extends \pdyn\httputils\HttpResource {
	...
	public static function applies($url, $mime, $body) {
		return (mb_strpos($mime, 'video/') === 0) ? true : false;
	}
	...
	protected function fetch_meta() {
		return [
			'author' => '',
			'title' => $this->url,
			'description' => 'Video from '.$this->url
		];
	}
	...
	public static function get_default_thumbnail() {
		return __DIR__.'/resource/defaultvideothumbnail.png';
	}
