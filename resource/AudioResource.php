...
/**
 * This handles audio resources.
 */
class AudioResource extends \pdyn\httputils\HttpResource {
	...
	public static function applies($url, $mime, $body) {
		return (mb_strpos($mime, 'audio/') === 0) ? true : false;
	}
	...
	protected function fetch_meta() {
		return [
			'author' => '',
			'title' => $this->url,
			'description' => 'Audio from '.$this->url
		];
	}
